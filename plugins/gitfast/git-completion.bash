...
if ! git --list-cmds=main >/dev/null 2>&1; then
	...
	__git_cmds[list-guide]="attributes cli core-tutorial credentials cvs-migration diffcore everyday faq glossary hooks ignore mailmap modules namespaces repository-layout revisions submodules tutorial tutorial-2 workflows"
